...
function MyBookings({ onLogout, userJsonVal, bookingCount }) {
    ...
    const handleOpenModal = (carId) => {
        ...
        fetch(`http://140.238.167.80:5000/car-service-redis/carshealth/${carId}`)
            .then((response) => response.json())
            .then((data) => {
                    ...
                    <div className="container">
                        <div className="row no-gutters">
                            <div className="col-md-12	featured-top">
                                <div className="row no-gutters">
                                    <div className="col-md-2 d-flex align-items-center bg-primary" style={{ 'marginTop': '40px', 'maxHeight': '110px' }}>
