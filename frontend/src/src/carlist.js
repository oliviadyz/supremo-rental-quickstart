                  ...
                  <div className="card-body">
                    <div className='car-wrap'>
                      <div className="text">
                        ...
                        <p className="d-flex mt-2 d-block"><Link to={`/carcheckout/${car.carid}`} className="btn btn-primary py-2 ml-1">Book Now</Link> <Link to={`/cardetails/${car.carid}`} className="btn btn-secondary py-2 ml-1">Details</Link>
                        </p>
                      </div>
                    </div>
                  </div>
